...
<head>
    ...
    <title>Política de Reembolsos</title>
...
// La consulta SQL que selecciona el contenido de la vista con id_vista = 4
$sql = "SELECT contenido FROM vistas WHERE id_vista = 4";
